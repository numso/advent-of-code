...
-- sObject : Decoder (List Int)
-- sObject =
--   let keyVals = keyValuePairs props in
--     customDecoder keyVals stripKeys

-- sList : Decoder (List Int)
-- sList =
--   let listVals = list props in
--     customDecoder listVals flatten

-- stripKeys : List (String, List Int) -> Result String (List Int)
-- stripKeys =
--   Ok << List.foldl (\(_, nums) memo -> memo ++ nums) []

-- flatten : List (List Int) -> Result String (List Int)
-- flatten =
--   Ok << List.foldl (++) []
